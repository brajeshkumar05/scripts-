<# This script is used to delete the database name from the list of database mentioned on the excel sheet and save it on the excel,
...
$outputFilePath = "G:\r0b0ffy\work\test_output3.xlsx"
